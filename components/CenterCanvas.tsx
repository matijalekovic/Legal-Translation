...
interface CenterCanvasProps {
  selectedDocument: UploadedDocument | undefined;
}
    ...
    <div className="flex-grow h-[calc(100vh-64px)] bg-lightGray-200 flex flex-col relative overflow-hidden">
      ...
      <div className="h-12 bg-white border-b border-lightGray-200 flex items-center justify-between px-4 shrink-0 z-10 shadow-sm">
        <div className="flex items-center space-x-2 overflow-hidden">
            ...
            <span className="text-sm font-medium text-navy-900 truncate max-w-[300px]">{selectedDocument.name}</span>
        </div>
      ...
      <div className="flex-grow overflow-auto p-8 custom-scrollbar bg-[#e2e8f0] flex justify-center">
        <div 
            className="bg-white shadow-lg border border-lightGray-300 min-h-[800px] transition-transform duration-200 origin-top"
            style={{ 
            ...
            <div className="p-12 md:p-16">
                {selectedDocument.previewContent ? (
                     <div 
                        ...
                        dangerouslySetInnerHTML={{ __html: selectedDocument.previewContent }}
                     />
                ) : (
